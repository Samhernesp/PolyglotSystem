"""
Django settings for polyglotSystem project.
...
SECRET_KEY = 'django-insecure-54hgvko^cs&3bysz#^og%(ygv512inon_1(w=h4su-*pqriv2c'
...
ROOT_URLCONF = 'polyglotSystem.urls'
...
WSGI_APPLICATION = 'polyglotSystem.wsgi.application'
